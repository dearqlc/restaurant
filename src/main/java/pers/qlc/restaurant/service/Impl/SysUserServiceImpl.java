...
import pers.qlc.restaurant.dao.SysMenuDao;
import pers.qlc.restaurant.dao.SysRoleDao;
import pers.qlc.restaurant.dao.SysUserDao;
import pers.qlc.restaurant.dao.UserRoleDao;
import pers.qlc.restaurant.entity.*;
import pers.qlc.restaurant.entity.request.UserRequest;
import pers.qlc.restaurant.exception.CustomException;
import pers.qlc.restaurant.service.SysUserService;
import pers.qlc.restaurant.utils.MenuUtil;
...
public class SysUserServiceImpl implements SysUserService {
    ...
    public List<SysMenu> findMenuTreeByUser(SysUser sysUser) {
        ...
        //根据角色信息，查询所拥有的菜单
        //格式化菜单
        return MenuUtil.formatMenuList(sysMenuDao.findList(sysMenu), false);
    }
